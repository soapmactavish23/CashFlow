...
{
    public class CashFlowClassFixture : IClassFixture<CustomerWebApplicationFactory>
    {

        private readonly HttpClient _httpClient;

        public CashFlowClassFixture(CustomerWebApplicationFactory webApplicationFactory) 
        {
